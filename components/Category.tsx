...
const ReviewCard = ({
  ...
  return (
    ...
    >
      ...
      <blockquote className="mt-2 text-xl text-primary font-semibold ">{body}</blockquote>
...
const Category = () => {
  return (
    <div className="font-poppins relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background py-24 md:shadow-xl">
        <div classname="text-center py-10 gap-3">
            <p className="text-4xl text-primary text-center font-semibold pb-2">Category</p>
            <p className="text-3xl text-primary text-center pb-8">Popular Categories</p>
        </div>
